...
- 初速60km/h、走行距離300mごとに基本速度が5km/h上昇（最大300km/h）。Near Missの2段階得点（車体間の最小距離0.18m以下は300点、それ以外の有効なNear Missは100点。コンボ倍率を適用）、コンボと最大+8m/sのTurbo、実走行速度の上限316.8km/h（88m/s）。
